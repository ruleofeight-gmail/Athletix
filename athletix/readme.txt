...
= 2.1.2 =
* Fix: hub tabs and the Customize/taxonomy menus are now bulletproof for administrators — the manage_athletix mapping runs at the highest priority (so a role/security plugin cannot strip it), and the hub always shows every tab to a manage_options administrator.
